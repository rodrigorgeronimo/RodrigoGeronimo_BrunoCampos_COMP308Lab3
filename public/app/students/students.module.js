System.register(['@angular/core', '@angular/common', '@angular/forms', '@angular/router', './students.routes', './students.component', './create/create.component', './list/list.component', './view/view.component', './edit/edit.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, forms_1, router_1, students_routes_1, students_component_1, create_component_1, list_component_1, view_component_1, edit_component_1;
    var StudentsModule;
    return {
        setters:[
            function (core_1_1) {
